...
// --- 1. DATOS: EL IMPOSTOR (MEGA PACK) ---
// NOTA: Le cambié el nombre de "words" a "impostorWords" para que coincida con la lógica
const impostorWords = [
    // --- MARCAS ---
...
// --- 2. DATOS: FRASE MALDITA (MEGA PACK) ---
const frases = [
...
// --- 3. DATOS: GUERRA DE CEREBROS (MEGA PACK) ---
const allTriviaQuestions = [
    ...
    { q: "¿Animal más rápido del mundo?", ans: ["León", "Águila", "Guepardo", "Halcón"], correct: 3 },
    ...
    { q: "¿Color del sable de Luke Skywalker?", ans: ["Rojo", "Morado", "Verde/Azul", "Naranja"], correct: 2 },
